...
⚠️ 当前 `scripts/train/walker_s2/configs/train_config_walker_s2_sim.json` / `model/Walker_S2_sim_act` 是 19 维仿真配置；P0 部署迁移不包含 19→31 维动作适配，不能默认直接用于 Walker 31 维真机 rollout。
